...
os.chdir(r"G:\My Drive\Study\ML\06.Random_Forest")
...
plt.savefig(r"G:\My Drive\Study\ML\06.Random_Forest\matplotlib_bar.png", dpi=300,bbox_inches='tight') 
plt.show();
...
#sns.regplot(x='reservation_n', y=Y_axis, data = df)               # linear regression model fit
#sns.lmplot(x='reservation_n', y=Y_axis, data = df)                # Combination of regplot & FacetGrid.
#sns.residplot(x='reservation_n', y=Y_axis, data=df);              # Residual values

############################################################################################################

plt.savefig(r"G:\My Drive\Study\ML\06.Random_Forest\Seaborn_bar.png", dpi=300,bbox_inches='tight') 

plt.show()

######### ggplot ###########################################
X_axis='reservation_n'
Y_axis='NOP_before_purchase'
X_axis_cat_1 = 'browser_cat'
X_axis_cat_2 = 'dd'
##################

#ggplot(df, aes(x=X_axis , y=Y_axis )) + geom_point()                               # Scatter
a=ggplot(df, aes(x=X_axis_cat_1)) + geom_bar()                                      # Bar
...
a.save(r"G:\My Drive\Study\ML\06.Random_Forest\ggplot_bar.png")
...
graph.hbar(df[X_axis], right =df[Y_axis], height = 0.5)  

#export_png(a, filename = r"G:\My Drive\Study\ML\06.Random_Forest\bokeh_bar.png") 
