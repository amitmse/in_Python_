...
Python Install: 
	...
	Install Library					 :pip install xgboost --proxy 10.20.221.17:8080	

									  same as above

									  set HTTP_PROXY=http://10.65.1.33:8080

									  set HTTPS_PROXY=http://10.65.1.33:8080

									  pip install pypdf2

	

		○ Operational Categorization 1     :Software Request-Install Software

		○ Operational Categorization 2     :Optional Software

		○ Request Type                                :Free Software

		○ Request Group                             :Non Dealing Room Users

		○ Existing Computer Name           :<Your System Name – IND or INN>

		○ Operating System                        :Windows 7

		○ License Key Application/Software :RStudio,Java 8 Update 74,R for Windows,Notepad++ (64-bit x64)Python 3.6.1,

-------------------------------------------------------------------------------------

Y:\Process Improvement\Python\Setup\READ_ME.txt

Install module 	-> pip install automl --proxy 10.20.221.17:8080

Proxy	              ->  http://scybernetwpad/wpad.dat

Install Python: pip install --upgrade numexpr --user
...
-------------------------------------------------------------------------------------
	...
	• Dask:
		...
		○ C:\Users\1567478\goldenversions\python-3.10.5-embed-amd64

		○ python get-pip.py -i https://artifactory.global.standardchartered.com/artifactory/api/pypi/pypi/simple

		○ C:\Users\1567478\goldenversions\python-3.10.5-embed-amd64\Python_codes
...
if name == '__main__':
    ...
    data_location=r"\\10.20.185.140\Projects\Portfolio_analytics\IN_CC_A_01"

    output_location=r"\\10.20.185.140\Data_Landing\IFRS9\99.Others\Temp- to be deleted\Data Tokenization - UAT\India"

    output  = '__List_of_Files_Data_Tokenization.csv'
...
# Change below
	...
	dirName = r"C:\Users\1567478\MyData\00.Work\Utility\Not is use"
...
#Zip a Folder
	...
	source_dir = r'\\10.20.185.140\gmv\MY_CC_IFRS9\Data\b_bcdm_card_smry_hist'  

	dest_dir = r'\\10.20.185.140\gmv\MY_CC_IFRS9\Data\b_bcdm_card_smry_hist'
	...
	#csv_files(r'\\10.20.185.140\gmv\MY_CC_IFRS9\Data\b_bcdm_card_smry_hist\2006')
