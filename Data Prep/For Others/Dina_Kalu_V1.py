...
sample_data=pd.read_csv(path_for_sample_data,names = [key_var, "test_var"], skiprows=2)
...
for file_nm in range(len(raw_csv_file_name)):
		...
		for folder_nm in dic_subdirectories_level_2.keys():
				...
				try: 	f_24_1 = pd.read_csv(input_folder+'/'+revoke1_24book1_24+'/'+dic_subdirectories_level_2[folder_nm]+'/'+raw_csv_file_name[file_nm]+'.csv', names = [key_var, raw_csv_file_name[file_nm]], skiprows=2 )
				...
				try: 	f_24_2 = pd.read_csv(input_folder+'/'+revoke1_24book25_36+'/'+dic_subdirectories_level_2[folder_nm]+'/'+raw_csv_file_name[file_nm]+'.csv', names = [key_var, raw_csv_file_name[file_nm]], skiprows=2)
				...
				try: 	f_24_3 = pd.read_csv(input_folder+'/'+revoke1_24book37_48+'/'+dic_subdirectories_level_2[folder_nm]+'/'+raw_csv_file_name[file_nm]+'.csv', names = [key_var, raw_csv_file_name[file_nm]], skiprows=2)
				...
				try: 	f_24_4 = pd.read_csv(input_folder+'/'+revoke1_24book49_999+'/'+dic_subdirectories_level_2[folder_nm]+'/'+raw_csv_file_name[file_nm]+'.csv', names = [key_var, raw_csv_file_name[file_nm]], skiprows=2)
...
for file_nm in range(len(raw_csv_file_name)):
		...
		for folder_nm in dic_subdirectories_level_2.keys():
				...
				try: 	f_24_5 = pd.read_csv(input_folder+'/'+revoke25_36book25_36+'/'+dic_subdirectories_level_2[folder_nm]+'/'+raw_csv_file_name[file_nm]+'.csv', names = [key_var, raw_csv_file_name[file_nm]], skiprows=2)
				...
				try: 	f_24_6 = pd.read_csv(input_folder+'/'+revoke25_36book37_48+'/'+dic_subdirectories_level_2[folder_nm]+'/'+raw_csv_file_name[file_nm]+'.csv', names = [key_var, raw_csv_file_name[file_nm]], skiprows=2)
				...
				try: 	f_24_7 = pd.read_csv(input_folder+'/'+revoke25_36book49_999+'/'+dic_subdirectories_level_2[folder_nm]+'/'+raw_csv_file_name[file_nm]+'.csv', names = [key_var, raw_csv_file_name[file_nm]], skiprows=2)
...
for file_nm in range(len(raw_csv_file_name)):
		...
		for folder_nm in dic_subdirectories_level_2.keys():
				...
				try: 	f_24_3 = pd.read_csv(input_folder+'/'+revoke25_36book25_36+'/'+dic_subdirectories_level_2[folder_nm]+'/'+raw_csv_file_name[file_nm]+'.csv', names = [key_var, raw_csv_file_name[file_nm]], skiprows=2)
				except: f_24_3 = pd.DataFrame(np.empty(0, dtype=[(key_var, sample_data[key_var].dtypes), (raw_csv_file_name[file_nm], sample_data[sample_data_columns[0]].dtypes)]))
...
for file_nm in range(len(raw_csv_file_name)):
		...
		for folder_nm in dic_subdirectories_level_2.keys():
				...
				try: 	f_24_8 = pd.read_csv(input_folder+'/'+revoke37_48book37_48+'/'+dic_subdirectories_level_2[folder_nm]+'/'+raw_csv_file_name[file_nm]+'.csv', names = [key_var, raw_csv_file_name[file_nm]], skiprows=2)
				...
				try: 	f_24_9 = pd.read_csv(input_folder+'/'+revoke37_48book49_999+'/'+dic_subdirectories_level_2[folder_nm]+'/'+raw_csv_file_name[file_nm]+'.csv', names = [key_var, raw_csv_file_name[file_nm]], skiprows=2)
...
for file_nm in range(len(raw_csv_file_name)):
		...
		for folder_nm in dic_subdirectories_level_2.keys():
				...
				try: 	f_24_4 = pd.read_csv(input_folder+'/'+revoke25_36book25_36+'/'+dic_subdirectories_level_2[folder_nm]+'/'+raw_csv_file_name[file_nm]+'.csv', names = [key_var, raw_csv_file_name[file_nm]], skiprows=2)
				except: f_24_4 = pd.DataFrame(np.empty(0, dtype=[(key_var, sample_data[key_var].dtypes), (raw_csv_file_name[file_nm], sample_data[sample_data_columns[0]].dtypes)]))

				try: 	f_24_5 = pd.read_csv(input_folder+'/'+revoke25_36book37_48+'/'+dic_subdirectories_level_2[folder_nm]+'/'+raw_csv_file_name[file_nm]+'.csv', names = [key_var, raw_csv_file_name[file_nm]], skiprows=2)
				except: f_24_5 = pd.DataFrame(np.empty(0, dtype=[(key_var, sample_data[key_var].dtypes), (raw_csv_file_name[file_nm], sample_data[sample_data_columns[0]].dtypes)]))

				try: 	f_24_6 = pd.read_csv(input_folder+'/'+revoke37_48book37_48+'/'+dic_subdirectories_level_2[folder_nm]+'/'+raw_csv_file_name[file_nm]+'.csv', names = [key_var, raw_csv_file_name[file_nm]], skiprows=2)
				except: f_24_6 = pd.DataFrame(np.empty(0, dtype=[(key_var, sample_data[key_var].dtypes), (raw_csv_file_name[file_nm], sample_data[sample_data_columns[0]].dtypes)]))				
